...
class Lock(_ContextManagerMixin, _LoopBoundMixin):
    ...
    if sys.version_info >= (3, 10):
        ...
        def __init__(self, *, loop: AbstractEventLoop | None = None) -> None: no_effects()
...
class Condition(_ContextManagerMixin, _LoopBoundMixin):
    _waiters: deque[Future[Any]]
    if sys.version_info >= (3, 10):
        def __init__(self, lock: Lock | None = None) -> None: no_effects()
    else:
        def __init__(self, lock: Lock | None = None, *, loop: AbstractEventLoop | None = None) -> None: no_effects()
...
class Semaphore(_ContextManagerMixin, _LoopBoundMixin):
    ...
    _waiters: deque[Future[Any]] | None
    if sys.version_info >= (3, 10):
        def __init__(self, value: int = 1) -> None: no_effects()
    else:
        def __init__(self, value: int = 1, *, loop: AbstractEventLoop | None = None) -> None: no_effects()
...
if sys.version_info >= (3, 11):
    ...
    class Barrier(_LoopBoundMixin):
        def __init__(self, parties: int) -> None: no_effects()
